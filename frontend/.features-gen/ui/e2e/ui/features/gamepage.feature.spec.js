...
test.describe('Game page', () => {
  ...
  test('User can give the correct answer', async ({ Given, When, Then, And, page }) => {
    ...
    // ÄNDRAD: Letar efter vänteskärmen istället för knappen
  ...
  test('User gets points and waits for the next level', async ({ Given, When, Then, And, page }) => {
    ...
    await When('I type "CAT" in the word input', null, { page });
    await And('I click the button "Confirm Word"', null, { page });
    // BORTTAGEN: Klicket på "Next Level"
    // ÄNDRAD: Kontrollerar att poängen visas korrekt medan vi väntar
