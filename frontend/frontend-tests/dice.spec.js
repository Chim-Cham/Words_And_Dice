...
test_1.test.beforeEach(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, page.route('http://localhost:5164/api/word/*/*', function (route) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                _c.sent();
                return [4 /*yield*/, page.route('**/api/games?name=*', function (route) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, route.fulfill({
                                        status: 201,
            ...
            case 5:
                _c.sent();
                return [4 /*yield*/, page.getByRole('button', { name: 'Host Game' }).click()];
            case 6:
                _c.sent();
                return [4 /*yield*/, (0, test_1.expect)(page.getByText('Loading word...')).toBeHidden({ timeout: 10000 })];
            case 7:
                _c.sent();
                return [2 /*return*/];
        }
...
(0, test_1.test)('dice-word-row renderas', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var row;
    var page = _b.page;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                row = page.locator('.dice-word-row');
                return [4 /*yield*/, (0, test_1.expect)(row).toBeVisible()];
            case 1:
                _c.sent();
                return [2 /*return*/];
        }
