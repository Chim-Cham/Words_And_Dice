...
test_1.test.describe('Join Game Flow', function () {
    ...
    (0, test_1.test)('need a username to join a game', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    page.on('dialog', function (dialog) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    (0, test_1.expect)(dialog.message()).toBe('Please enter a username first!');
    ...
    (0, test_1.test)('able to nav to join game', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.getByPlaceholder('Username').fill('TestSpelaren')];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Join game' }).click()];
                case 2:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('heading', { name: 'Join Game' })).toBeVisible()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByPlaceholder('Enter Game ID')).toBeVisible()];
                case 4:
                    _c.sent();
                    return [2 /*return*/];
            }
    ...
    (0, test_1.test)('able to join game with valid game id', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
    ...
    (0, test_1.test)('go from join game back to start page', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.getByPlaceholder('Username').fill('TestSpelaren')];
                ...
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByPlaceholder('Username')).toBeVisible()];
                case 4:
                    _c.sent();
                    return [2 /*return*/];
            }
